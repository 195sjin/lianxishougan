...
// 静态代码块：初始化时读取配置文件  
    static {  
        try {  
            ...
            accessKeyId = properties.getProperty("aliyun.oss.access-key-id");  
            accessKeySecret = properties.getProperty("aliyun.oss.access-key-secret");  
            endpoint = properties.getProperty("aliyun.oss.endpoint");  
            bucketName = properties.getProperty("aliyun.oss.bucket-name");  
